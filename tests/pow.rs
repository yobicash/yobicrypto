...
//! Yobicrypto `pow` module tests.

extern crate yobicrypto;
extern crate rug;

use yobicrypto::{Memory, Random, Digest, BalloonParams, PoWTarget, PoW};
...
fn pow_memory_fail() {
    ...
    let one = Memory::from(1);
    let faulty_memory = default_memory - one;
    let difficulty = 10;
